...
// designer-notes setup script (Cursor edition)
// Deterministic project setup: injects script tags, starts server, creates changelog.
// Called by the /designer-notes slash command in Cursor.
//
// Usage: node setup-cursor.js <project-dir> [filename.html]
...
const SKILL_DIR = path.join(process.env.HOME, '.cursor', 'designer-notes');
